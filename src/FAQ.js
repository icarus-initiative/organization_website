      ...
      <Section>
        ...
        <Ul>
          <Li>
            ...
            iteratively improve the curriculum by building projects, evaluating
            resources, and voting on curriculum development.
          </Li>
          <Li>
            This initiative came about due to the myriad of resources that can
            often leave the uninitiated lost on their learning path.
          </Li>
        </Ul>
        ...
        <Ul>
          <Li>
            ...
            , have some programming experience like javascript or python, and be
            willing to pioneer.
          </Li>
          <Li>
            To get a better idea, get a sample of the minimum skills for the 1st
            project listed more in depth in the{' '}
            <a
        ...
        <Ul>
          ...
          <Li>Many other incentives, partnerships, and growth are planned.</Li>
        </Ul>

        <H3>What role can I play in this initiative?</H3>
        <Ul>
          <Li>
            <strong>Member</strong> - A member of the community who wishes to
            observe or is looking to join/create a squad.
          </Li>
          <Li>
          ...
          <Li>
            ...
            members thoughts & concerns, communicating with admins to build out
            the curriculum further. Captains are obviously pilots also because
            they are leading their squad on the expedition.
          </Li>
          <Li>
            <strong>Admin</strong> - Set up systems and infrastructure for
            squads and the organization, optimize systems to demystify knowledge
            and make more accessible, and handle any public relations.
          </Li>
        </Ul>
        ...
        <Ul>
          <Li>
            A squad consisting of 4-6 members embark on expeditions to level up
          ...
          <Li>
            There's many variables left up to the squad to decide if something
            more fitting including other projects, expedition length, additional
            resources, and any other innovative ideas.
          </Li>
          <Li>
            At least one of the members will be the captain, who will delegate
            and serve as a representive for the squadron. It's recommended that
            there's 2 captains to make the squad flow with major hitches. They
            would help with merging PRs, gathering the group, and communicating
            with organization admins.
          </Li>
          <Li>
            While there's the personal learning aspect, the social aspect will
            promote cohesion and cameraderie. We use various platforms that will
        ...
        <Ul>
          ...
          <Li>
            As planned, you can join as a pilot or captain. Eventually captains
            can advance to admin.
          </Li>
        </Ul>
        ...
        <Ul>
          <Li>
            Crowdsourcing can be a powerful force to help build the community
            that this initiative aims to harness and transmute into a platform
            for new learners.
          </Li>
          <Li>
            The aim is not to make a set curriculum but rather one that can be
            flexible and adaptive to the community needs.
          </Li>
          <Li>
            A lot of the power is distributed to each squadron to as how they
            want to guide their own learning. The squadron comes together and
            validates ideas to contribute back to the initiative. Think of the
            Socratic method meet blockchain concepts.
          </Li>
          <Li>
            Members, pilots, and captains are encouraged to take charge of their
            own learning, disseminate knowledge and experiences for future
            learners, and blazing a trail where there are none.
          </Li>
          <Li>
            These contributions can take various forms such as creating
            deliverables for consumption, helping to answer technical questions,
            or leading events.
          </Li>
        </Ul>
        <H3>
        ...
        <Ul>
          ...
          <Li>
            In the meantime, why not take a bet on yourself and your dev skills?
          </Li>
          <Li>
